...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">ALBUM FOTO RANGKUTI </a>
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        ...
                        <ul class="nav pull-right">
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="images/tes.png" class="nav-avatar" />
                                <b class="caret"></b></a>
                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a href="{{ url('category') }}"><i class="menu-icon icon-book"></i> CATEGORY </a></li>
                                <li><a href="{{ url('post') }}"><i class="menu-icon icon-book"></i>POST</a></li>
                                <li><a href="{{ url('photo') }}"><i class="menu-icon icon-book"></i>PHOTOS</a></li>
        ...
        <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2020 M Ferdiansah Rkt - UIN-Sumatera Utara </b>
            </div>
        </div>
